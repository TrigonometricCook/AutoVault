...
function PdfCard({
    ...
    const renderPDF = async () => {
      try {
        ...
        const canvas = document.getElementById(
          `canvas-${component.part_number}-${component.version_number}`
  ...
  return (
    <div className="flex flex-col p-4 border border-gray-200 rounded-2xl shadow-md bg-white text-black hover:shadow-lg transition duration-200 ease-in-out transform hover:scale-[1.02] cursor-pointer relative">
      ...
      <div className="relative">
        ...
        <canvas
          id={`canvas-${component.part_number}-${component.version_number}`}
          ref={canvasRef}
    ...
    <div className="w-full max-w-6xl mx-auto mt-8 space-y-8 px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {filteredComponents.map((component) => {
          const key = `${component.part_number}-${component.version_number}`;
          ...
          return (
            <PdfCard
              ...
              fileUrl={fileUrl}
              component={component}
              canvasRef={(el) => (canvasRefs.current[key] = el)}
            />
          );
        })}
      </div>
